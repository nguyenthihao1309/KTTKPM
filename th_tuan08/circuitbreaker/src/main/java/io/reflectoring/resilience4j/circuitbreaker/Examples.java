...
public class Examples
{
    ...
    void countBasedSlidingWindow_FailedCalls() {
        ...
        SearchRequest request = new SearchRequest("NYC", "L4X", "12/31/2020");
        service.setPotentialFailure(new SucceedNTimesAndThenFail(20));
    ...
    void timeBasedSlidingWindow_FailedCalls() {
        CircuitBreakerConfig config = CircuitBreakerConfig
            ...
            .minimumNumberOfCalls(3) //yêu cầu ít nhất cái lần trong 1 khoảng thời gian nào đó, chỉ có trong Time_based
            .slidingWindowSize(10)
            .failureRateThreshold(70.0f)
            .build();
        CircuitBreakerRegistry registry = CircuitBreakerRegistry.of(config);
